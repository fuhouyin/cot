    ...
    <body>
        ...
        <div id="login-container"style="margin-left:150px">
            ...
            <div class="block animation-fadeInQuick" style="background:#941818;opacity:0.5;" >
                ...
                <font color ="#fff">${requestScope.message }</font>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <input type="password" name="password" class="form-control" placeholder="输入密码" onkeyup="value=value.replace(/[^\0-\9\a-\z]/g,'');" required="required" >
                        </div>
                    </div>
                    
                    <!--<div class="form-group">
						<label class="col-xs-12">验证码</label>
						<div class="col-xs-12">
						<input class="form-control"  name="code" type="text" placeholder="输入验证码" required="required">
						<img src="{:captcha_src()}" onclick="this.src='{:captcha_src()}?'+Math.random();" width="150" alt="captcha" />
                        </div>
                    </div> -->                   
                    ...
                    <div class="form-group form-actions" style="color:grad">                      
                        <div class="col-xs-4 text-right" >
                            ...
                            <a href="zc" class="btn btn-effect-ripple btn-sm btn-success" style="margin-right: -130px">去注册</a>
                        </div>
                    </div>
                </form>
            ...
            $("#username").blur(function () {
                $.ajax({
                    ...
                    success: function (data) {      //成功，回调函数
	                    if(data == 0){
	                    	alert("亲,账号 "+$("input[name='username']").val()+" 不存在");
